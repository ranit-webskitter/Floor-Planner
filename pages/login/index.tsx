...
//       toast.success(response?.data?.user?.aud)
//       console.log(response)
//       response?.data?.session?.access_token && router.push('/floor-plan')
//       response?.error && toast.error(response?.error?.message)

//       Cookies.set('token', response?.data?.session.access_token, { expires: 1 });
//       setLoading(false)
