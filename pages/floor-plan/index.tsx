...
//   //       cellData: [
//   //         ...Object.values(currentRoom.cellData).filter((cell) => cell.index !== selectedCell),
//   //         formData,
//   //       ],
//   //     };
...
//         roomId: currentRoom.code, // Assuming currentRoom.code is your roomId
...
//       const updatedRoom = {
//         ...currentRoom,
//         occupiedCells: Object.values(currentRoom.occupiedCells).filter(cell => cell !== selectedCell),
//         cellData: Object.values(currentRoom?.cellData).filter(cell => cell.index !== selectedCell),
//       };
//       updateRoomMutation.mutate(updatedRoom);
//       setCurrentRoom(updatedRoom);
//     }
